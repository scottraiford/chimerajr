#!/usr/bin/env python
# Modified by Scott Raiford for Chimera Jr.
# Original source is https://github.com/DexterInd/GrovePi/blob/master/Software/Python/grove_gesture_sensor/grove_gesture_sensor.py
